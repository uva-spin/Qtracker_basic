...
def custom_multi_track_loss(y_true: tf.Tensor, y_pred: tf.Tensor) -> tf.Tensor:
    """
    Custom loss function for multi-track events that combines sparse categorical cross-entropy for mu+ and mu-
    predictions with an overlap penalty to discourage overlapping predictions.
