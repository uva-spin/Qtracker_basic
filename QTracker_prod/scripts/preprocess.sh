...
python Util/skim_v2.py data/original_files/JPsi_Dump_1M.root \
    --output_file data/raw_files/JPsi_Dump_Train.root \
    --max_events 456000

echo "Skim MUP train set"
python Util/skim_v2.py \
...
python Util/skim_v2.py data/original_files/MUP_Dump_1M.root \
    --output_file data/raw_files/MUP_Dump_Val.root \
    --max_events 27500000 \
    --start 220000000

echo "Skim MUM val set"
python Util/skim_v2.py data/original_files/MUM_Dump_1M.root \
